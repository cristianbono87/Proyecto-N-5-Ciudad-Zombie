...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 165, 350, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 165, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 550, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 430, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 280, 230, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 760, 200, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 280, 80, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 70, 280, 15, 30, 1)
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 120, 280, 10, 10, 1.5, {desdeX: 80, hastaX: 170, desdeY: 220, hastaY: 280}),
    new ZombieCaminante('imagenes/zombie2.png', 100, 400, 10, 10, 1.5, {desdeX: 80, hastaX: 190, desdeY: 380, hastaY: 420}),
    new ZombieCaminante('imagenes/zombie3.png', 500, 130, 10, 10, 1.5, {desdeX: 500, hastaX: 580, desdeY: 120, hastaY: 130}),
    new ZombieCaminante('imagenes/zombie3.png', 400, 380, 10, 10, 1.5, { desdeX: 400, hastaX: 480, desdeY: 380, hastaY: 450}),
    new ZombieCaminante('imagenes/zombie3.png', 750, 220, 10, 10, 1.5, { desdeX: 750, hastaX: 850, desdeY: 220, hastaY: 280}),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 5, {desdeX: 25, hastaX: 850, desdeY: 322, hastaY: 322},'H'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 50, 30, 90, 4, {desdeX: 644, hastaX: 644, desdeY: 30, hastaY: 450},'V'),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 250, 30, 90, 6, {desdeX: 674, hastaX: 674, desdeY: 30, hastaY: 450},'V')
  ]
};
